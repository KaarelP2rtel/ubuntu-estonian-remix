...
export output_file_name="$(ls $iso_file_path | grep i386 | cut -d'-' -f1)-estonian-remix-$(ls $iso_file_path | grep i386 | cut -d'-' -f2)-$(ls $iso_file_path | grep i386 | cut -d'-' -f4 | cut -d'.' -f1)"
